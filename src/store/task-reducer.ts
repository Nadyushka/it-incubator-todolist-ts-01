...
import {v1} from "uuid";
import {ADD_TODOLIST, AddToDoListActionType, RemoveToDoListActionType} from "./todoList-reducer";
...
export const taskReducer = (tasks: TaskStateType = initialState, action: taskReducerActionTypes): TaskStateType => {
    switch (action.type) {
        case REMOVE_TASK:
            return {
                ...tasks,
